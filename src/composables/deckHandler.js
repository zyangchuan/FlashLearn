...
const deckHandler = () => {
  ...
  const loadDeck = async () => {
    ...
    try {
      const response = await axios.get('https://f4ng7av2s6.execute-api.ap-southeast-1.amazonaws.com/flashlearn-test/card-decks/edit-deck', loadDeck_config)
  ...
  return { deckName, deckDesc, cards, loadDeck, deleteDeck, editDeckName, editDeckDesc, updateDeck }
}
